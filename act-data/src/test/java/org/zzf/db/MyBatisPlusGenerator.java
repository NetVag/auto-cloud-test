...
public class MyBatisPlusGenerator {
    public static void main(String[] args) {
        ...
        String serverInfo = "106.55.254.162:3306";
        String targetModuleNamePath = "/act-data";
        String dbName = "auto_test_test_data";
        String[] tables = {
