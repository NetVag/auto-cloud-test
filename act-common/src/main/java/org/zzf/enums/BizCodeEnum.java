...
public enum BizCodeEnum {
    ...
    DATA_NOT_FOUND(100404, "数据不存在"),
    SYSTEM_ERROR(100500, "系统内部错误"),
    ...
    MINIO_FILE_NOT_EXIST(1001, "文件不存在"),
    MINIO_PARAM_ERROR(1002, "MinIO参数非法（如过期时间为负、文件路径为空）"),
    MINIO_SERVICE_ERROR(1003, "MinIO服务异常（如桶不存在、密钥错误）"),
    MINIO_EXPIRE_TIME_OVER_LIMIT(1004, "临时链接过期时间最长不超过7天"),
